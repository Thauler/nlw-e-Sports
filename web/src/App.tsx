      ...
      <div className='grid grid-cols-6 gap-6 mt-16'>
        ...
        <a href="" className="relative rounded-lg overflow -hidden">
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute left-0 right-0 bottom-0 ">
            ...
            <span className="text-sm text-zinc-300 block mt-1">1 anúncios</span>
          </div>
        ...
        <a href="" className="relative rounded-lg overflow -hidden">
          <img src="/game-3.png" alt="" />
           ...
           <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute left-0 right-0 bottom-0 ">
            ...
            <span className="text-sm text-zinc-300 block mt-1">10 anúncios</span>
          </div>
        ...
        <a href="" className="relative rounded-lg overflow -hidden">
          <img src="/game-4.png" alt="" />
           ...
           <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute left-0 right-0 bottom-0 ">
            ...
            <span className="text-sm text-zinc-300 block mt-1">3 anúncios</span>
          </div>
